...
Mallary works now as a custom Claude connector. The public Connectors Directory listing is being prepared.

1. Go to `Customize` → `Connectors`.
2. Click `+`, then choose `Add custom connector`.
3. Enter `Mallary` as the name and `https://mallary.ai/mcp` as the URL.
4. Click `Connect` and complete the Mallary OAuth flow.

<Card title="Mallary for Claude" href="/home/claude">
  See the full Claude connector setup, safety guidance, and feature list.
</Card>
