...
Examples include post type selection, TikTok direct-vs-upload mode, Pinterest board selection, YouTube visibility, and Google Business call-to-action data.
