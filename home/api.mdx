...
description: "Mallary API is a social media posting and scheduling API for developers. Use it to upload media, publish posts, schedule content, fetch analytics, manage webhooks, and disconnect platforms across Facebook, Instagram, LinkedIn, YouTube, TikTok, Pinterest, Reddit, Google Business, Snapchat, and X."
---

Mallary API is a developer-friendly social media API for uploading media, creating posts, scheduling content, tracking job status, reading analytics, managing webhooks, and controlling connected publishing platforms from one integration.
...
The API key owner is always authoritative. Identity is resolved from the API key, not from a supplied `user_id`.
...
- media attachments
- follow-up comments with `comments_under_post`
...
Examples include post type selection, Pinterest board selection, YouTube visibility, and Google Business call-to-action data.
