...
description: "Mallary API is a social media posting and scheduling API for developers. Use it to upload media, publish posts, schedule content, fetch analytics, manage webhooks, and disconnect platforms across Facebook, Instagram, LinkedIn, YouTube, TikTok, Pinterest, Reddit, Snapchat, and X."
---
...
Examples include post type selection, TikTok direct-vs-upload mode, Pinterest board selection, and YouTube visibility.
