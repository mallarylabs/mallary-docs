...
For interactive use and AI agent harnesses, the CLI supports browser-based OAuth with read-only access by default. API-key authentication remains available as an optional override for CI and other non-interactive environments.
