...
- A Reel needs one 9:16 MP4 or MOV video. It must be 4 to 60 seconds long and at least 540 by 960 pixels.
...
Add `thumbnail_url` to a Facebook feed video in `media`. Use a JPG or PNG file stored by Mallary. The thumbnail can be up to 10 MB.
