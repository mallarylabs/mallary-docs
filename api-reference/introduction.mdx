---
title: "API Overview"
description: "Mallary API supports uploads, multi-platform publishing, grouped post retrieval, comment listing/replies, analytics, connected platform listing, webhooks, and platform disconnects."
---
...
//   status: "queued",
//   batch_id: "a1b2c3d4",
//   jobs: [{ platform: "facebook", jobId: "123", platform_post_id: null, platform_post_url: null }]
// }
```
...
//   platform_post_url: "https://www.facebook.com/..."
// }
```
...
Mallary supports multiple connected accounts per platform by grouping connections into named profiles. Existing accounts use the default profile.

Use `GET /api/v1/profiles` to list each profile's random public ID, such as `AbC123xYz90`.

Pass `profile_id` to publish, list posts, read analytics, list connected platforms, update settings, or disconnect a platform for a non-default profile.
