...
Mallary enforces platform-specific media rules before it queues jobs.
...
Mallary groups connections into named profiles. This supports multiple connected accounts per platform. Existing accounts use the default profile.
