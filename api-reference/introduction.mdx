---
title: "API Overview"
description: "Mallary API supports uploads, multi-platform publishing, comments, post analytics, audience counts, connected platforms, webhooks, and platform disconnects."
---
